...
efibootmgr --create --disk /dev/nvme0n1 --part 1 --label 'Arch Linux' \
	...
	--unicode "initrd=/intel-ucode.img initrd=/initramfs-linux.img cryptdevice=UUID=$(blkid -s UUID -o value /dev/nvme0n1p2):cryptroot root=/dev/mapper/cryptroot rw debug ignore_loglevel"
```
